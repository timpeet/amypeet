export const cv = {
  name: 'Amy Peet',
  title: 'Archivist & Digital Asset Specialist',
  contact: {
    email: 'amy.joanna.peet@gmail.com',
  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        { label: 'Archive & Team Oversight', text: 'Managed the archive department, overseeing the professional development of assistants and internship programme recruitment.' },
        { label: 'Digital Platforms', text: 'Maintained the primary portfolio website and subsidiary platforms, managing content updates, social media feeds, and the company FTP server.' },
        { label: 'Asset Curation', text: 'Sourced assets for numerous high-profile books and exhibitions, ensuring immediate availability of digital and analogue resources.' },
        { label: 'Rights & Clearances', text: 'Negotiated image licensing agreements and managed complex clearances involving hundreds of concurrent usage conversations.' },
        { label: 'Syndication', text: 'Managed international syndication agents, ensuring adherence to contractual obligations and strict editorial embargoes.' },
      ],
    },
    {
      company: 'Eyevine',
      url: 'https://www.eyevine.com/',
      role: 'Production Assistant & Photographer',
      period: 'August 2007 – January 2012',
      bullets: [
        { label: 'Production', text: 'Managed high-volume daily production, including technical metadata application such as keywording and captioning for international editorial syndication.' },
        { label: 'Training', text: 'Aided in the training of others to maintain rigorous quality and workflow efficiency.' },
      ],
    },
    {
      company: 'Various',
      ...
      period: 'Pre-2007',
      bullets: [
        { label: 'Tony Latham Photography', text: 'Photographic Assistant.' },
        { label: 'Loop Images', text: 'Syndication Library Keyworder.' },
        { label: 'AnOther Magazine', text: 'Editorial Intern.' },
      ],
    },
  ],
  skills: [
  ...
  education: [
    ...
    {
      degree: 'BTEC Foundation Studies in Art & Design',
      institution: 'Suffolk College',
      grade: 'Distinction',
    },
    {
      degree: 'A-Levels & AS-Levels',
      institution: 'Northgate Sixth Form',
      grade: '2 A-Levels Grade A, 4 AS-Levels Grade A',
    },
  ],
}
